    ...
    return (
        <div>
            <Box sx={{ m: '25vh 0 0 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <Typography variant="h2" sx={{ m: '2rem 0', color: 'primary.main', fontWeight: 800 }}>{labels.welcome}</Typography>
                <Typography variant="h1" sx={{ mb: '2rem', color: 'primary.main'  }}>{labels.title}</Typography>
