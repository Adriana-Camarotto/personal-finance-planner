...
import { Container, Box, FormControl, InputLabel, Select, MenuItem, Button, Typography, Snackbar, Alert } from '@mui/material';
            ...
            <Box sx={{ mb: 4, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Box sx={{ display: 'flex', gap: 2 }}>
                    ...
                    <FormControl sx={{ width: '150px' }}>
                        ...
                        >
                            {['2024', '2025', '2026', '2027', '2028', '2029', '2030'].map((year, index) => (
