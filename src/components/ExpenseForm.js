...
import { Box, TextField, Button, InputAdornment, FormControl, Select, MenuItem, InputLabel, Menu } from '@mui/material';
    ...
    <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <FormControl fullWidth required sx={{ mb: 0.1, backgroundColor: 'white' }}>
        ...
        >
          ...
          <MenuItem value="Bills">Bills (agua, luz, celular, internet)</MenuItem>
